...
class Map:
    ...
    def create_map(self):
        objects_number = randrange(170, 180)
        for i in range(objects_number):
            self.objects[i] = ['m1', randrange(0, self.width, 40), randrange(0, self.height, 40)]
        for i in range(objects_number):
            self.objects[objects_number+i] = ['m2', randrange(0, self.width, 40), randrange(0, self.height, 40)]
